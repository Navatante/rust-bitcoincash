...
#[doc(inline)]
pub use primitives::block::{Block, Checked, Unchecked, Validation, Version, BlockHash, Header};
#[doc(no_inline)]
...
impl Encodable for Block<Unchecked> {
    ...
    fn consensus_encode<W: io::Write + ?Sized>(&self, w: &mut W) -> Result<usize, io::Error> {
        ...
        let block = self.clone().assume_checked();
...
mod tests {
    ...
    use crate::{block, Amount, CompactTarget, Network, Sequence, TestnetVersion};
    ...
    fn static_vector() {
        ...
        let block = Block::new_unchecked(header, transactions).assume_checked();
    ...
    fn block() {
        ...
        let real_decode =
            Block::new_unchecked(header, transactions.clone()).assume_checked();
    ...
    fn block_version() {
        ...
        let real_decode = decode.unwrap().assume_checked();
        ...
        let real_decode2 = decode2.unwrap().assume_checked();
